...
class AnimatedSplash extends React.Component {
  ...
  render() {
    ...
    if (typeof logoHeight === "string" && !logoHeight.includes("%")) {
      console.warn(
        "AnimatedSplash: logoHeight prop should be a percentage string"
      )
    }

    if (typeof logoWidth === "string" && !logoWidth.includes("%")) {
      console.warn(
        "AnimatedSplash: logoWidth prop should be a percentage string"
      )
    }
